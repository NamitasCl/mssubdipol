...
import { X, Calendar as CalendarIcon, AlertCircle, Plus, Trash2, CheckCircle, Info } from "lucide-react";
...
export default function IngresoFuncionariosAporte({ show, onHide, calendario, aporte, onGuardado }) {
    const { user } = useAuth();
    ...
    const handleAgregar = async (e) => {
        ...
        const idUnidad = esAdmin ? unidadSeleccionada?.value : aporte?.idUnidad;
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-4xl flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
                ...
                <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    <h3 className="text-xl font-bold text-gray-900">Agregar Funcionario</h3>
                            ...
                            <div className="md:col-span-4 flex flex-col gap-3 pt-6">
                                ...
                                <div className="bg-gray-50 p-3 rounded-xl border border-gray-100">
                                    <label className="flex items-center gap-2 cursor-pointer">
                                        ...
                                        />
                                        <span className="text-sm text-gray-700 font-medium select-none">Sin días no disponibles</span>
                                    </label>
                                </div>
                            </div>
                        </div>
